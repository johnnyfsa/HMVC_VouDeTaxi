	...
	public ClienteLandPage() {
		...
		generateRaceBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(FrameController.getClienteLandPage(),"Campo Obrigat�rio Vazio");
				}
				else 
				{
					...
					else 
					{
						...
						else 
						{
							...
							if(diferenca<30) 
							{
								JOptionPane.showMessageDialog(FrameController.getClienteLandPage(),"Agendamentos s� podem ser realizados com at� 30 min de anteced�ncia");
							}
							else 
							{
